...
const struct security_class_mapping secclass_map[] = {
	{ "security",
	  { "compute_av", "compute_create", "compute_member", "check_context",
	    ...
	    "validate_trans", "setmaxns", "setmaxnsdepth", NULL } },
	{ "process",
	...
	{ "bpf",
	  { "map_create", "map_read", "map_write", "prog_load", "prog_run",
	    "map_create_as", "prog_load_as", "link_create", "link_read",
	    "link_update", "link_detach", "link_pin", "btf_load", "btf_read",
	    "map_enumerate", "prog_enumerate", "link_enumerate",
	    "btf_enumerate", NULL } },
