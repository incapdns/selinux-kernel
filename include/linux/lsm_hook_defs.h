...
LSM_HOOK(int, 0, inode_setxattr_override, struct mnt_idmap *idmap,
	 struct dentry *dentry, const char *name, const void *value,
	 size_t size, int flags)
...
LSM_HOOK(void, LSM_RET_VOID, kernfs_free_security, struct kernfs_node *kn)
...
LSM_HOOK(void, LSM_RET_VOID, task_setns_cred_for_children,
...
LSM_HOOK(int, 0, request_sock_clone_security,
	 const struct request_sock *old, struct request_sock *new)
LSM_HOOK(void, LSM_RET_VOID, request_sock_free_security,
	 struct request_sock *req)
...
LSM_HOOK(void, LSM_RET_VOID, skb_free_security, void *security)
...
LSM_HOOK(int, 0, xfrm_state_alloc_acquire, struct xfrm_state *x,
	 struct xfrm_sec_ctx *polsec, const struct flowi_common *flic)
LSM_HOOK(void, LSM_RET_VOID, xfrm_state_free_security, struct xfrm_state *x)
LSM_HOOK(int, 0, xfrm_state_delete_security, struct xfrm_state *x)
LSM_HOOK(int, 0, xfrm_policy_lookup, struct xfrm_sec_ctx *ctx,
	 const struct flowi_common *flic)
LSM_HOOK(int, 1, xfrm_sec_ctx_match, struct xfrm_sec_ctx *first,
