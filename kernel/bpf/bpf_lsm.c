...
BTF_ID(func, bpf_lsm_prop_ref_capture)
...
BTF_ID(func, bpf_lsm_bpf_btf)
BTF_ID(func, bpf_lsm_bpf_btf_load)
BTF_ID(func, bpf_lsm_bpf_map_relation)
BTF_ID(func, bpf_lsm_bpf_prog_map_relation)
BTF_ID(func, bpf_lsm_bpf_prog_commit)
BTF_ID(func, bpf_lsm_bpf_btf_free)
